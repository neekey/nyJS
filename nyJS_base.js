   ...
   _coms: {
     ...
     date: component_base.inherit({
       ...
       prototype: {
         ...
         build_select: function(select_info){
           ...
           for(var i = select_info.max; i >= select_info.min; i--){
             ...
             if(i == select_info.selected){
               select_info.jq.append('<option selected="selected" value="' + i +'">' + option_value + '</option>');
             }
             else{
         ...
         set_select: function(timestamp){
           ...
           this.other_jq.year.val(this.date.getFullYear());
           this.other_jq.month.val(this.date.getMonth() + 1);
           this.other_jq.day.val(this.date.getDate());
         },
         /**
          * 获取指定年份和月份下的天数
          */
         ...
         update_day: function(){
           ...
           if(day_value <= day_num){
             this.other_jq.day.val(day_value);
           }
     ...
     tab: component_base.inherit({
       ...
       constructor: function(com_info){
          ...
          * target_id 为目标的id值
          */
         this.tabs = this.base_jq.find('a.' + this.class);
       ...
       prototype: {
           ...
           this.controller.response({
             page_switch: {
               rebuild: function(args){
                 var cur_index = $(args._this).attr('href').substr(1);
                 // 设置当前页并跟新数据
         ...
         build: function(){
           ...
           if(jQuery.isEmptyObject(this.base_jq)){
             var paging = '<' + this.tag + ' class="' + this.class + '" id="' + this.id +'" ></' + this.tag +'>';
             this.base_jq =  $(paging);
           }
           // 清空
           this.base_jq.empty();
           
           this.first = $('<span class="' + this.class + '_first" id="' + this.id +'_first" ><a href="#' + this.first_index + '" >' + this.setting.first + '</a></span>').appendTo(this.base_jq);
           this.prev = $('<span class="' + this.class + '_prev" id="' + this.id +'_prev" ><a href="#' + this.prev_index + '" >' + this.setting.prev + '</a></span>').appendTo(this.base_jq);
           this.cur_left = $('<span class="' + this.class + '_cur_left" id="' + this.id +'_cur_left" ></span>').appendTo(this.base_jq);
           this.cur = $('<span class="' + this.class + '_cur" id="' + this.id +'_cur" >' + this.cur_index + '</span>').appendTo(this.base_jq);
           this.cur_right = $('<span class="' + this.class + '_cur_right" id="' + this.id +'_cur_right" ></span>').appendTo(this.base_jq);
           this.next = $('<span class="' + this.class + '_next" id="' + this.id +'_next" ><a href="#' + this.next_index + '" >' + this.setting.next + '</a></span>').appendTo(this.base_jq);
           this.last = $('<span class="' + this.class + '_last" id="' + this.id +'_last" ><a href="#' + this.last_index + '" >' + this.setting.last+ '</a></span>').appendTo(this.base_jq);
